...
@WebServlet(name = "Upload_Biofuels_First_pol_name", urlPatterns = {"/Upload_Biofuels_First_pol_name"})
@MultipartConfig
public class Upload_Biofuels_First_pol_name extends HttpServlet {
            ...
            while (rowIterator.hasNext()) {
                ...
                while (cellIterator.hasNext()) {
                    ...
                    if (ur > 3) {
                        ...
                        } else if (uc>0 && uc < COUNT_OF_NAMES+1) {
                            criteria_of_output[uc-1] = cell.getStringCellValue();
                        } else {
